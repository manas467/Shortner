...
const LandingPage = () => {
  ...
  <h2 className='my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl text-white text-center font-extrabold'>
   ...
   <form className='sm:h-14 flex flex-col sm:flex-row w-full md:w-2/4 gap-2' onSubmit={handleShorten}>
    <Input type="url" placeholder="enter your looongg Url" className="h-full flex-1 py-4 px-4   " value={longUrl} onChange={(e)=>setlongUrl(e.target.value)}/>
    <Button type="submit" className="h-full" variant='destructive'>Shorten</Button>
   </form>
    <img src='./urlshortnerbanner.png' className='w-full my-11 md:px-11'/>
